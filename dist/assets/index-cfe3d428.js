...
`,Er=c.div`
  ...
  align-items: center;
  margin-left: 3rem;
`;function Cr(){E();const{user:r}=P(),i=Pt();return p.exports.useEffect(()=>{r===null&&i("/")},[r]),t(yr,{children:[t(Er,{children:[e(J,{inEditor:!0}),e(Z,{inEditor:!0})]}),e(mt,{inWorkshop:!0}),e(dt,{inEditor:!0})]})}function Ar(){return e(bt,{children:t(Qt,{children:[e(xe,{path:"*",element:e(kr,{})}),e(xe,{path:"/grade-calculator/editor",element:e(Cr,{})})]})})}gt.createRoot(document.getElementById("root")).render(e(rt.StrictMode,{children:e(Zt,{children:e(qt,{children:e(Ar,{})})})}));
