...
`,Xt={color:"#bfb0ed"};function w({type:r,title:o,onClick:u,id:s,className:n,icon:i}){return t(qt,{type:r,className:n,id:s,onClick:u,children:[o,i===!0?e(xt,{style:Xt,size:25}):""]})}const Ot=c.div`
  width: 100%;
  border-radius: 4px;
  div.socialLinks {
...
`;function rt(){return e(Ot,{children:t("div",{className:"socialLinks",children:[e("a",{target:"_blank",href:"https://www.instagram.com/gabriel_supz/",children:e(ft,{size:30,color:"#b45cb0"})}),t("a",{target:"_blank",href:"https://www.linkedin.com/in/gabriel-suptitz-51340124a/",children:[" ",e(wt,{size:30,color:"#8777cc"})]}),t("a",{href:"mailto:gabrielsuptitz@gmail.com",children:[" ",e(vt,{size:30,color:"var(--text-color)"})]}),t("a",{target:"_blank",href:"https://github.com/gabrielsupz",children:[" ",e(kt,{size:30,color:"#b3afc4"})]})]})})}const Ut={apiKey:"AIzaSyC0NN4MzL1cbcSl1eccQKx3HVg4Xyk-EGk",authDomain:"grade-calculator-24ed6.firebaseapp.com",projectId:"grade-calculator-24ed6",storageBucket:"grade-calculator-24ed6.appspot.com",messagingSenderId:"29173795505",appId:"1:29173795505:web:1033bf56cb09eed41a3090"},nt=jt(Ut);new et;const re=It(nt),q=St(nt),it=p.exports.createContext(void 0),Kt=({children:r})=>{const[o,u]=p.exports.useState(null),[s,n]=p.exports.useState(),i=()=>{const a=new et;Gt(re,a)},d=()=>{Rt(re)};return p.exports.useEffect(()=>{const a=Bt(re,m=>{u(m),m!==null&&n(m.uid)});return()=>{a()}},[]),p.exports.useEffect(()=>{},[]),e(it.Provider,{value:{googleSignIn:i,logOut:d,user:o,uid:s},children:r})},V=()=>p.exports.useContext(it),Wt=c.div`
  display: none;
...
`;function f({returnValue:r,numberGrade:o}){const[n,i]=p.exports.useState(""),d=a=>{const m=Math.max(0,Math.min(100,Number(a.target.value)));i(m),r(m)};return t(_t,{children:[" ",t("label",{htmlFor:"number"+o,children:["Nota ",o,": "]}),e("input",{placeholder:"0",onChange:d,value:n===0?"":n,id:"number"+o,type:"number"})]})}const er=c.p`
  display: flex;
  justify-content: center;
  align-items: center;
  font-size: 1.6rem;
...
`,Te=c.div`
  ...
  align-items: center;
  gap: 1rem;
`;function nr(r){const[o,u]=p.exports.useState(),[s,n]=p.exports.useState(),[i,d]=p.exports.useState();function a(l){u(l)}function m(l){n(l)}function h(l){d(l)}return r.modelType==="bimestre"?t(Ve,{children:[" ",t(ze,{children:[e("h3",{className:"h2",children:"Nota necessária "}),e(f,{returnValue:a,numberGrade:"1"}),e(f,{returnValue:m,numberGrade:"2"}),e(f,{returnValue:h,numberGrade:"3"})]}),t(Te,{children:[e(He,{children:"Precisa de:"}),e(Re,{v1:Number(o),v2:Number(s),v3:Number(i),weight1:Number(r.weight1),weight2:Number(r.weight2),weight3:Number(r.weight3),weight4:Number(r.weight4),average:Number(r.average)})]})]}):r.modelType==="trimestre"?t(Ve,{children:[" ",t(ze,{children:[e("h3",{className:"h2",children:"Nota necessária "}),e(f,{returnValue:a,numberGrade:"1"}),e(f,{returnValue:m,numberGrade:"2"})]}),t(Te,{children:[e(He,{children:"Precisa de:"}),e(Re,{v1:Number(o),v2:Number(s),weight1:Number(r.weight1),weight2:Number(r.weight2),weight3:Number(r.weight3),average:Number(r.average)})]})]}):e(N,{})}const ir=c.div`
  display: flex;
  flex-direction: row;
  width: 100%;
  justify-content: space-around;
  margin-top: 1rem;
`;function or({average:r,modelName:o,modelType:u,weight1:s,weight2:n,weight3:i,weight4:d}){return t(ir,{children:[e(tr,{modelName:o,modelType:u,weight1:s,weight2:n,weight3:i,weight4:d,average:r}),e(nr,{modelName:o,modelType:u,weight1:s,weight2:n,weight3:i,weight4:d,average:r})]})}const A=M`
from {
  opacity: 0;
  transform: translatex(-100px);
}
...
`;function pr({PeriodOfTime:r}){const[o,u]=p.exports.useState(),[s,n]=p.exports.useState(),[i,d]=p.exports.useState(),[a,m]=p.exports.useState();function h(b){u(b)}function l(b){n(b)}function g(b){d(b)}function y(b){m(b)}return r==="bi"?t(De,{children:[" ",t(Le,{children:[e("h2",{children:"Nota Final "}),e(f,{returnValue:h,numberGrade:"1"}),e(f,{returnValue:l,numberGrade:"2"}),e(f,{returnValue:g,numberGrade:"3"}),e(f,{returnValue:y,numberGrade:"4"})]}),t(Ye,{children:[e(Fe,{children:"Resultado:"}),e(Qe,{v1:Number(o),v2:Number(s),v3:Number(i),v4:Number(a)})]})]}):r==="tri"?t(De,{children:[" ",t(Le,{children:[e("h2",{children:"Nota Final "}),e(f,{returnValue:h,numberGrade:"1"}),e(f,{returnValue:l,numberGrade:"2"}),e(f,{returnValue:g,numberGrade:"3"})]}),t(Ye,{children:[e(Fe,{children:"Resultado:"}),e(Qe,{v1:Number(o),v2:Number(s),v3:Number(i)})]})]}):e(N,{})}const gr=c.header`
  ...
  filter: drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25));
`;function qe(){return t(gr,{children:[e("h1",{id:"top",children:"Calculadora de Notas"}),e(Mt,{size:90,color:"var(--text-color)"})]})}const Xe=c.div`
...
`;function ct({inWorkshop:r}){const{period:o}=E();return r===!0?t($e,{children:[e(qe,{}),e(Oe,{inWorkshop:!0}),e("div",{className:"divWithBackground",children:e(mr,{})})]}):t($e,{children:[e(qe,{}),e(Oe,{}),t("div",{className:"divWithBackground",children:[e(pr,{PeriodOfTime:o}),e(xr,{PeriodOfTime:o})]})]})}const fr=c.div`
  display: flex;
...
`,wr=c.div`
  ...
  align-items: center;
  margin-left: 3rem;
`;function vr(){const{period:r}=E();return t(fr,{children:[t(wr,{children:[e(X,{period:r}),e(Y,{text:`Calcule a sua nota final ou a nota que precisa tirar para atingir a
        média, o peso define quantas vezes será contada a nota e o total da soma será dividido pela quantidade de notas somadas`})]}),e(Jt,{}),e(ct,{}),e(ot,{})]})}const kr=c.div`
  display: flex;
...
`,yr=c.div`
  ...
  align-items: center;
  margin-left: 3rem;
`;function Er(){E();const{user:r}=V(),o=Pt();return p.exports.useEffect(()=>{r===null&&o("/")},[r]),t(kr,{children:[t(yr,{children:[e(X,{inEditor:!0}),e(Y,{inEditor:!0})]}),e(ct,{inWorkshop:!0}),e(ot,{inEditor:!0})]})}function Ar(){return e(bt,{children:t(Qt,{children:[e(pe,{path:"*",element:e(vr,{})}),e(pe,{path:"/editor",element:e(Er,{})})]})})}gt.createRoot(document.getElementById("root")).render(e(_e.StrictMode,{children:e(Kt,{children:e(Yt,{children:e(Ar,{})})})}));
